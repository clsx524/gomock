...
//go:generate mockgen -destination internal/mock_gomock/mock_matcher.go github.com/clsx524/gomock/gomock Matcher
...
import (
	...
	"github.com/clsx524/gomock/gomock/internal/mock_gomock"
)
